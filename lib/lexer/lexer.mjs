...
export class Lexer {
  ...
  constructor(/** @type {LexerOptions} */ delegate) {
  ...
  #emit(
    ...
    if (type === errorToken) {
      ...
      this.#entry = S.Bogus;
      this.#triggerWriteCallback([this.#tokens[TokenType.bogusStart], "<!"]);
      ...
      this.#entry =
        this.#lastTagType === TokenType.startTagStart && !xmlIsh
          ...
          : S.Main;
      const ttype =
        this.#buffer[end - 2] === "/" ? "tagEndAutoclose" : "tagEnd";
      this.#triggerWriteCallback([
        ttype,
  ...
  #triggerWriteCallback(/** @type {[string, string]} */ value) {
    if (this.#onWrite) {
